	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case CODE_UPDATE_DIALOG:
				...
				break;
			case CODE_URL_ERROR:
				Toast.makeText(SplasActivity.this, "url错误", Toast.LENGTH_SHORT)
						.show();
				enterHome();
				break;
			case CODE_NET_ERROR:
				Toast.makeText(SplasActivity.this, "网络错误", Toast.LENGTH_SHORT)
						.show();
				enterHome();
				break;
			case CODE_JSON_ERROR:
				Toast.makeText(SplasActivity.this, "数据解析错误",
		...
		if (Environment.getExternalStorageState().equals(
			...
			utils.download(mDownloadUrl, target, new RequestCallBack<File>() {
				...
				public void onFailure(HttpException arg0, String arg1) {
					Toast.makeText(SplasActivity.this, "下载失败!",
							Toast.LENGTH_SHORT).show();
				}
			...
			Toast.makeText(SplasActivity.this, "没有找到sdcard!",
						Toast.LENGTH_SHORT).show();
		}
	}
